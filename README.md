...
| Link | Description |
|---|---|
| [./2026-csforca-virtual](./2026-csforca-virtual) | This directory holds starter files and documentation for the [2026 CSforCA Virtual Workshop](https://www.linkedin.com/posts/csforca_csforca-csisai-csisfoundational-activity-7434270679312773120-foSd/) presentation. |
...
| [./Languages](./Languages) | The `Languages` app is test of [ISO 639](https://en.wikipedia.org/wiki/List_of_ISO_639_language_codes) languages, [ISO 1366](https://en.wikipedia.org/wiki/ISO_3166) countries, and [UNSD M49](https://unstats.un.org/unsd/methodology/m49/) regions supported by the [Translator](https://ai2.appinventor.mit.edu/reference/components/media.html#Translator) and [TextToSpeech](https://ai2.appinventor.mit.edu/reference/components/media.html#TextToSpeech) components. |
| [./MapLongPress](./MapLongPress) | The `MapLongPress` app demonstrates using `LongPressAtPoint` to add latitude and longitude values to a `TinyDB` each time the map is long-pressed. The `Button` clears the entries. |
