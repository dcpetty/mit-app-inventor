...
[&#128279; permalink](https://psb-david-petty.github.io/mit-app-inventor/MapLongPress/), [&#128297; repository](https://github.com/psb-david-petty/mit-app-inventor/tree/master/MapLongPress), and [![MIT AI2 logo](../mit-app-inventor-2-logo-200x200.png){:width="36px"} `.AIA`](https://psb-david-petty.github.io/mit-app-inventor/MapLongPress/MapLongPress.aia) for this page.
